...
public class YR_MODULE_IMPORT {
    ...
    public static MemoryAddress module_name$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_MODULE_IMPORT.module_name$VH.get(seg);
    }
    ...
    public static MemoryAddress module_name$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_MODULE_IMPORT.module_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress module_data$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_MODULE_IMPORT.module_data$VH.get(seg);
    }
    public static void module_data$set( MemorySegment seg, MemoryAddress x) {
        YR_MODULE_IMPORT.module_data$VH.set(seg, x);
    }
    public static MemoryAddress module_data$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_MODULE_IMPORT.module_data$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void module_data$set(MemorySegment seg, long index, MemoryAddress x) {
