...
public class YR_ATOMS_CONFIG {
    ...
    public static MemoryAddress get_atom_quality$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_ATOMS_CONFIG.get_atom_quality$VH.get(seg);
    }
    public static void get_atom_quality$set( MemorySegment seg, MemoryAddress x) {
        YR_ATOMS_CONFIG.get_atom_quality$VH.set(seg, x);
    }
    public static MemoryAddress get_atom_quality$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_ATOMS_CONFIG.get_atom_quality$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void get_atom_quality$set(MemorySegment seg, long index, MemoryAddress x) {
        YR_ATOMS_CONFIG.get_atom_quality$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static YR_ATOMS_QUALITY_FUNC get_atom_quality (MemorySegment segment, MemorySession session) {
        return YR_ATOMS_QUALITY_FUNC.ofAddress(get_atom_quality$get(segment), session);
    }
    ...
    public static MemoryAddress quality_table$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_ATOMS_CONFIG.quality_table$VH.get(seg);
    }
    public static void quality_table$set( MemorySegment seg, MemoryAddress x) {
        YR_ATOMS_CONFIG.quality_table$VH.set(seg, x);
    }
    public static MemoryAddress quality_table$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_ATOMS_CONFIG.quality_table$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void quality_table$set(MemorySegment seg, long index, MemoryAddress x) {
