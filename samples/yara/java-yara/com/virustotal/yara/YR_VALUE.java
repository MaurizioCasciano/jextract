...
public class YR_VALUE {
    ...
    public static MemoryAddress p$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.p$VH.get(seg);
    }
    ...
    public static MemoryAddress p$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.p$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress o$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.o$VH.get(seg);
    }
    public static void o$set( MemorySegment seg, MemoryAddress x) {
        YR_VALUE.o$VH.set(seg, x);
    }
    public static MemoryAddress o$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.o$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void o$set(MemorySegment seg, long index, MemoryAddress x) {
    ...
    public static MemoryAddress s$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.s$VH.get(seg);
    }
    ...
    public static MemoryAddress s$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.s$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress it$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.it$VH.get(seg);
    }
    ...
    public static MemoryAddress it$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.it$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress ss$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.ss$VH.get(seg);
    }
    public static void ss$set( MemorySegment seg, MemoryAddress x) {
        YR_VALUE.ss$VH.set(seg, x);
    }
    public static MemoryAddress ss$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.ss$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ss$set(MemorySegment seg, long index, MemoryAddress x) {
    ...
    public static MemoryAddress re$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.re$VH.get(seg);
    }
    public static void re$set( MemorySegment seg, MemoryAddress x) {
        YR_VALUE.re$VH.set(seg, x);
    }
    public static MemoryAddress re$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_VALUE.re$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void re$set(MemorySegment seg, long index, MemoryAddress x) {
