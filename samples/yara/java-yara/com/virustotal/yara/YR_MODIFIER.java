...
public class YR_MODIFIER {
    ...
    public static MemoryAddress alphabet$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_MODIFIER.alphabet$VH.get(seg);
    }
    public static void alphabet$set( MemorySegment seg, MemoryAddress x) {
        YR_MODIFIER.alphabet$VH.set(seg, x);
    }
    public static MemoryAddress alphabet$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_MODIFIER.alphabet$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void alphabet$set(MemorySegment seg, long index, MemoryAddress x) {
