...
public class YR_ATOM_LIST_ITEM {
    ...
    public static MemoryAddress next$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_ATOM_LIST_ITEM.next$VH.get(seg);
    }
    ...
    public static MemoryAddress next$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_ATOM_LIST_ITEM.next$VH.get(seg.asSlice(index*sizeof()));
    }
