...
public class RE_NODE {
    ...
    public static MemoryAddress re_class$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)RE_NODE.re_class$VH.get(seg);
    }
    public static void re_class$set( MemorySegment seg, MemoryAddress x) {
        RE_NODE.re_class$VH.set(seg, x);
    }
    public static MemoryAddress re_class$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)RE_NODE.re_class$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void re_class$set(MemorySegment seg, long index, MemoryAddress x) {
    ...
    public static MemoryAddress children_head$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)RE_NODE.children_head$VH.get(seg);
    }
    ...
    public static MemoryAddress children_head$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)RE_NODE.children_head$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress children_tail$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)RE_NODE.children_tail$VH.get(seg);
    }
    ...
    public static MemoryAddress children_tail$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)RE_NODE.children_tail$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress prev_sibling$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)RE_NODE.prev_sibling$VH.get(seg);
    }
    public static void prev_sibling$set( MemorySegment seg, MemoryAddress x) {
        RE_NODE.prev_sibling$VH.set(seg, x);
    }
    public static MemoryAddress prev_sibling$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)RE_NODE.prev_sibling$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void prev_sibling$set(MemorySegment seg, long index, MemoryAddress x) {
    ...
    public static MemoryAddress next_sibling$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)RE_NODE.next_sibling$VH.get(seg);
    }
    ...
    public static MemoryAddress next_sibling$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)RE_NODE.next_sibling$VH.get(seg.asSlice(index*sizeof()));
    }
