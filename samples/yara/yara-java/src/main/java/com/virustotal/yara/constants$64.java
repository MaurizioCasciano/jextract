...
class constants$64 {
    ...
    static final MethodHandle clock_settime$MH = RuntimeHelper.downcallHandle(
        "clock_settime",
        constants$64.clock_settime$FUNC
    );
    ...
    static final MethodHandle clock_nanosleep$MH = RuntimeHelper.downcallHandle(
        "clock_nanosleep",
        constants$64.clock_nanosleep$FUNC
    );
    ...
    static final MethodHandle clock_getcpuclockid$MH = RuntimeHelper.downcallHandle(
        "clock_getcpuclockid",
        constants$64.clock_getcpuclockid$FUNC
    );
    ...
    static final MethodHandle timer_create$MH = RuntimeHelper.downcallHandle(
        "timer_create",
        constants$64.timer_create$FUNC
    );
    ...
    static final MethodHandle timer_delete$MH = RuntimeHelper.downcallHandle(
        "timer_delete",
        constants$64.timer_delete$FUNC
    );
    ...
    static final MethodHandle timer_settime$MH = RuntimeHelper.downcallHandle(
        "timer_settime",
        constants$64.timer_settime$FUNC
    );
}
