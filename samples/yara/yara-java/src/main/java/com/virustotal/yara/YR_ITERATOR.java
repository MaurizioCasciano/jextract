...
public class YR_ITERATOR {
    ...
    public static MemoryAddress next$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)YR_ITERATOR.next$VH.get(seg);
    }
    ...
    public static MemoryAddress next$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)YR_ITERATOR.next$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static YR_ITERATOR_NEXT_FUNC next (MemorySegment segment, MemorySession session) {
        return YR_ITERATOR_NEXT_FUNC.ofAddress(next$get(segment), session);
    }
