...
class constants$86 {
    ...
    static final MethodHandle pthread_key_create$__destr_function$MH = RuntimeHelper.downcallHandle(
        constants$86.pthread_key_create$__destr_function$FUNC
    );
    ...
    static final MethodHandle pthread_key_create$MH = RuntimeHelper.downcallHandle(
        "pthread_key_create",
        constants$86.pthread_key_create$FUNC
    );
    ...
    static final MethodHandle pthread_key_delete$MH = RuntimeHelper.downcallHandle(
        "pthread_key_delete",
        constants$86.pthread_key_delete$FUNC
    );
    ...
    static final MethodHandle pthread_getspecific$MH = RuntimeHelper.downcallHandle(
        "pthread_getspecific",
        constants$86.pthread_getspecific$FUNC
    );
    ...
    static final MethodHandle pthread_setspecific$MH = RuntimeHelper.downcallHandle(
        "pthread_setspecific",
        constants$86.pthread_setspecific$FUNC
    );
    ...
    static final MethodHandle pthread_getcpuclockid$MH = RuntimeHelper.downcallHandle(
        ...
        constants$86.pthread_getcpuclockid$FUNC
    );
}
